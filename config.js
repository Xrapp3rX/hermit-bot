...
module.exports = {
  VERSION: 'v4.4.4',
  SESSION_ID: process.env.SESSION_ID || 'HQ_2024_AUG_28_FGEKIN',
  ...
  BOT_NAME: process.env.BOT_NAME || '‼️𝘕 𝘰 _ 𝘔 𝘦 𝘳 𝘊 𝘺‼️',
  ...
  BOT_INFO: process.env.BOT_INFO || '‼️𝘕 𝘰 _ 𝘔 𝘦 𝘳 𝘊 𝘺‼️;919922281834;https://telegra.ph/file/ea5e4fb5d460072212b22.jpg',
  AUDIO_DATA: process.env.AUDIO_DATA || '‼️𝘕 𝘰 _ 𝘔 𝘦 𝘳 𝘊 𝘺‼️;https://telegra.ph/file/ea5e4fb5d460072212b22.jpg',
  STICKER_DATA: process.env.STICKER_DATA || '‼️𝘕 𝘰 _ 𝘔 𝘦 𝘳 𝘊 𝘺‼️',
